...
#data3 = data3.replace(to_replace = {'What is your gender?': is not '0' and is not '1' and is not '2'}, value = '2')
...
data3.to_csv(r'C:\Users\lcalzado\Desktop\datasetUsable.csv', index=False);
